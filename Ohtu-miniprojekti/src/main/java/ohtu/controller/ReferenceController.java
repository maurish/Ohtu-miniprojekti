...
public class ReferenceController {
    ...
    public String createInproc(@ModelAttribute("inproceedings") @Valid Inproceedings inproc, BindingResult bindingresult, Model model) {
        return add("inproceedings", inproc, bindingresult, model);
    }
    ...
    public String updateInproc(@ModelAttribute("inproceedings") @Valid Inproceedings inproc, BindingResult bindingresult, Model model) {
        return update("inproceedings", inproc, bindingresult, model);
    }
    ...
    private void addAll(Model model) {
        ...
        addOne(model, "inproceedings", new Inproceedings());
    }
